 ...
 */
export const ProposalHTMLTemplate = React.forwardRef<
  HTMLDivElement,
  ProposalHTMLTemplateProps
  ...
  return (
    ...
    >
      ...
      <div className="pdf-page">
        ...
        <div
          style={{
            ...
            marginBottom: '15mm',
            paddingBottom: '8mm',
            borderBottom: `2px solid ${COMPANY_BRANDING.primaryColor}`,
          }}
        >
          <div style={{ textAlign: 'right', flex: 1 }}>
            ...
            <p style={{ fontSize: '10px', marginBottom: '4px' }}>
              {COMPANY_BRANDING.address}
            </p>
            <p style={{ fontSize: '10px', marginBottom: '4px' }}>
              טלפון: {COMPANY_BRANDING.phone}
            </p>
            <p style={{ fontSize: '10px' }}>אימייל: {COMPANY_BRANDING.email}</p>
          </div>
          {COMPANY_BRANDING.logoPath && (
            <img
              src={COMPANY_BRANDING.logoPath}
              alt="Logo"
        ...
        >
          ...
          <p style={{ marginBottom: '4px', fontSize: '11px' }}>
            תאריך: {formatHebrewDate(today)}
          </p>
          <p style={{ color: '#666', fontSize: '11px' }}>
            תוקף ההצעה: עד {formatHebrewDate(validUntil)} (
            {COMPANY_BRANDING.proposalValidity} ימים)
          </p>
        </div>
        ...
        <p style={{ fontSize: '11px', lineHeight: '1.8' }}>
          לאחר ניתוח מעמיק של תהליכי העבודה שלכם, זיהינו{' '}
          {proposalData.summary.totalServices} פתרונות אוטומציה ו-AI. ההשקעה
          הכוללת: {formatPrice(proposalData.totalPrice)}
        ...
        >
          ...
          <tbody>
            {services.map((service, index) => (
              <tr
                key={service.id}
                style={{ background: index % 2 === 1 ? '#f8fafc' : 'white' }}
              >
                <td
                  style={{
                    padding: '12px',
                ...
                >
                  {Math.max(
                    1,
                    (service.customDuration || service.estimatedDays || 0) - 1
                  )}{' '}
                  ימים
                </td>
                <td
      ...
      <div className="pdf-page">
        ...
        <p style={{ color: '#666', marginBottom: '20px' }}>
          כל שירות מותאם במיוחד לצרכים שזיהינו
        </p>
          ...
          >
            ...
            <div style={{ marginTop: '15px' }}>
              ...
              >
                ...
                >
                  {formatPrice(
                    (service.customPrice || service.basePrice) * 1.18
                  )}
                </p>
              </div>
              <div
        ...
        >
          ...
          >
            <div style={{ flex: 1 }}>
              ...
              >
                {proposalData.summary.totalServices}
              </div>
            </div>
            <div style={{ flex: 1 }}>
              <div
          ...
          <div style={{ textAlign: 'center', marginTop: '20px' }}>
            <div style={{ marginBottom: '10px' }}>
              <div
                style={{ fontSize: '10px', color: '#666', marginBottom: '3px' }}
              >
                מחיר בסיס (כבר מופחת ב-30%, ללא מע"מ)
              </div>
              <div
      ...
      <div className="pdf-page">
        ...
        <p style={{ paddingRight: '15px', marginBottom: '20px' }}>
          • {COMPANY_BRANDING.paymentTermsHe}
        </p>
        ...
        >
          <li>
            משך הפרויקט: {Math.ceil(proposalData.totalDays / 5)} שבועות (
            {proposalData.totalDays} ימי עבודה)
          </li>
