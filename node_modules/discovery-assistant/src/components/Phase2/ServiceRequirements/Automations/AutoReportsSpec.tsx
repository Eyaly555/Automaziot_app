...
export function AutoReportsSpec() {
  ...
  useEffect(() => {
    ...
    const existing = automations.find(
      (a: any) => a.serviceId === 'auto-reports'
    );
            ...
            <div>
              ...
              <div className="space-y-2">
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    checked={config.includeManagement}
                    onChange={(e) =>
                      setConfig({
                        ...config,
                        includeManagement: e.target.checked,
                      })
                    }
                    className="mr-2"
                  />
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) =>
                      setConfig({ ...config, includeTeam: e.target.checked })
                    }
                    className="mr-2"
                  />
                ...
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    checked={config.includeCustomEmails}
                    onChange={(e) =>
                      setConfig({
                        ...config,
