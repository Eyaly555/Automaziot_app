...
export function AutoLeadResponseSpec() {
  ...
  useBeforeUnload(() => {
    ...
    const completeConfig = {
      ...
      n8nWorkflow: {
        ...
        webhookEndpoint:
          n8nWebhookEndpoint.value || config.n8nWorkflow.webhookEndpoint,
      },
    };
  ...
  const handleFieldChange = useCallback(
    (field: keyof AutoLeadResponseRequirements, value: any) => {
      setConfig((prev) => {
          ...
          if (!isLoadingRef.current) {
            const completeConfig = {
              ...
              n8nWorkflow: {
                ...
                webhookEndpoint:
                  n8nWebhookEndpoint.value ||
                  updated.n8nWorkflow.webhookEndpoint,
              },
            };
            saveData(completeConfig);
          }
    ...
    <div className="space-y-6 p-8" dir="rtl">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900">
          שירות #1: מענה אוטומטי ללידים מטפסים
        </h2>
        <p className="text-gray-600 mt-2">
          הגדרת מענה אוטומטי ללידים שמגיעים מטפסים באתר
        </p>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-green-800">
              חלק מהשדות מולאו באופן אוטומטי מנתונים שכבר נאספו בשלב 1 או
              בשירותים אחרים. זה חוסך זמן ומונע טעויות!
            </p>
          </div>
        </div>
      )}
              ...
              <div className="flex items-center gap-4">
                <label className="flex items-center gap-2">
                  <input
                    type="checkbox"
                    checked={
                      config.formPlatformAccess.webhookCapability || false
                    }
                    onChange={(e) =>
                      handleFieldChange(
                        'formPlatformAccess.webhookCapability',
                        e.target.checked
                      )
                    }
                ...
                <label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      handleFieldChange(
                        'formPlatformAccess.pluginRequired',
                        e.target.checked
                      )
                    }
                    className="rounded border-gray-300"
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleFieldChange(
                        'emailServiceAccess.rateLimits.daily',
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleFieldChange(
                        'emailServiceAccess.rateLimits.monthly',
                        parseInt(e.target.value) || 0
                      )
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg"
              ...
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    handleFieldChange(
                      'emailServiceAccess.domainVerified',
                      e.target.checked
                    )
                  }
                  className="rounded border-gray-300"
            ...
            <div className="space-y-4">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleFieldChange(
                      ...
                      e.target.value as 'oauth' | 'api_key' | 'basic_auth'
                    )
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFieldChange('crmAccess.module', e.target.value)
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg"
          ...
          <div className="border-t pt-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="block text-sm font-medium text-gray-700">
                    {n8nWebhookEndpoint.metadata.label.he}{' '}
                    <span className="text-red-500">*</span>
                  </label>
