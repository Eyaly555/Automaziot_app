...
const DEFAULT_CATEGORIES: TriageCategory[] = [
  {
    ...
    name: 'Sales',
    nameHe: 'מכירות',
    keywords: ['quote', 'price', 'buy', 'purchase'],
    autoAssignTo: 'sales@company.com',
  },
  {
    id: '2',
    name: 'Support',
    ...
    autoAssignTo: 'support@company.com',
  },
  {
    id: '3',
    name: 'Billing',
    nameHe: 'חשבונאות',
    keywords: ['invoice', 'payment', 'refund', 'billing'],
    autoAssignTo: 'billing@company.com',
  },
  {
    id: '4',
    name: 'Technical',
    nameHe: 'טכני',
    keywords: ['api', 'integration', 'technical', 'bug'],
    autoAssignTo: 'tech@company.com',
  },
  {
    id: '5',
    name: 'General',
    nameHe: 'כללי',
    keywords: ['general', 'question', 'info'],
    autoAssignTo: 'info@company.com',
  },
];
...
export const AITriageSpec: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<
    'basic' | 'categories' | 'priority' | 'routing' | 'sentiment' | 'vip'
  >('basic');
  ...
  useEffect(() => {
    ...
    const existing = aiAgentServices.find(
      (a: AIAgentServiceEntry) => a.serviceId === 'ai-triage'
    );
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                AI Triage - Service #27 - Classification, Sentiment Analysis,
                Priority & Routing
              </p>
            </div>
            <Button
          ...
          <div className="p-6">
                    ...
                    <Select
                      ...
                      onChange={(e) => {
                        ...
                        setConfig((prev) => ({
                          ...
                          aiModel:
                            AI_MODELS[newProvider]?.[0]?.value || 'gpt-4o-mini',
                        }));
                      }}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-700 mb-2">
                        GPT-4o Mini מומלץ לסיווג - מספיק טוב ב-60%+ דיוק, מהיר
                        (&#60;5 שניות), וזול ($0.15/$0.60 למיליון tokens).
                      </p>
                      <p className="text-sm text-blue-700">
                        עלות משוערת: 1,000 פניות ליום × 500 tokens ממוצע =
                        ~$0.30 ליום (~$9/חודש)
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      הגדר 5-10 קטגוריות לסיווג פניות
                    </p>
                  </div>
                  <Button
                    onClick={addCategory}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-yellow-700">
                        מומלץ להתחיל עם 5-7 קטגוריות בסיסיות. יותר מדי קטגוריות
                        יכול להוריד את הדיוק. וודא שמילות המפתח ברורות ולא
                        חופפות בין קטגוריות.
                      </p>
                    </div>
                  </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      הגדר כללים לקביעת עדיפות אוטומטית
                    </p>
                  </div>
                  <Button
                    ...
                    {config.priorityRules.map((rule, index) => (
                      ...
                      >
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            ...
                            <Select
                              ...
                              onChange={(e) =>
                                updatePriorityRule(rule.id, {
                                  resultPriority: e.target.value as any,
                                })
                              }
                        ...
                        <p className="text-xs text-gray-500 mt-2">
                          הערה: התנאים המדויקים יוגדרו ב-n8n workflow (מילות
                          מפתח, סנטימנט, דרגת לקוח, וכו')
                        </p>
                      </div>
                    ))}
                  </div>
                    ...
                    {config.routingRules.map((rule, index) => (
                      ...
                      >
                          ...
                          <div>
                            ...
                            <Select
                              ...
                              options={[
                                ...
                                {
                                  value: 'person',
                                  label: 'אדם ספציפי (Person)',
                                },
                                {
                                  value: 'department',
                                  label: 'מחלקה (Department)',
                                },
                                {
                                  value: 'round_robin',
                                  label: 'Round Robin (חלוקה שווה)',
                                },
                              ]}
                            />
                          </div>
                        ...
                        <label className="flex items-center gap-2 mt-3">
                          ...
                          />
                          <span className="text-sm text-gray-700">
                            הקצה אוטומטית ליעד (ללא התערבות ידנית)
                          </span>
                        </label>
                      </div>
                    ))}
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    זיהוי תסכול, כעס, דחיפות ושביעות רצון בפניות
                  </p>
                </div>
                      ...
                      <div className="grid grid-cols-5 gap-3">
                        <div>
                          ...
                          <Input
                            ...
                            max="1"
                            value={
                              config.sentimentAnalysis.thresholds.veryNegative
                            }
                            onChange={(e) =>
                              setConfig({
                                ...config,
                                sentimentAnalysis: {
                                  ...config.sentimentAnalysis,
                                  thresholds: {
                                    ...config.sentimentAnalysis.thresholds,
                                    veryNegative: parseFloat(e.target.value),
                                  },
                                },
                              })
                            }
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            max="1"
                            value={
                              config.sentimentAnalysis.thresholds.veryPositive
                            }
                            onChange={(e) =>
                              setConfig({
                                ...config,
                                sentimentAnalysis: {
                                  ...
                                  thresholds: {
                                    ...config.sentimentAnalysis.thresholds,
                                    veryPositive: parseFloat(e.target.value),
                                  },
                                },
                              })
                            }
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <label className="flex items-center gap-2">
                          <input
                            type="checkbox"
                            checked={
                              config.sentimentAnalysis.emotionDetection
                                .detectFrustration
                            }
                            onChange={(e) =>
                              setConfig({
                              ...
                              setConfig({
                                ...
                                sentimentAnalysis: {
                                  ...
                                  emotionDetection: {
                                    ...config.sentimentAnalysis
                                      .emotionDetection,
                                    detectUrgency: e.target.checked,
                                  },
                                },
                              })
                            }
                              ...
                              setConfig({
                                ...
                                sentimentAnalysis: {
                                  ...
                                  emotionDetection: {
                                    ...config.sentimentAnalysis
                                      .emotionDetection,
                                    detectDisappointment: e.target.checked,
                                  },
                                },
                              })
                            }
                              ...
                              setConfig({
                                ...
                                sentimentAnalysis: {
                                  ...
                                  emotionDetection: {
                                    ...config.sentimentAnalysis
                                      .emotionDetection,
                                    detectExcitement: e.target.checked,
                                  },
                                },
                              })
                            }
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-blue-700">
                            60%+ מארגונים משתמשים בניתוח סנטימנט לשיפור חוויית
                            לקוח. זיהוי תסכול + VIP customer = auto-escalate
                            ל-high priority מפחית zמניעה נזק מוניטין.
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            {activeTab === 'vip' && (
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-1">
                    טיפול ב-VIP ולקוחות מיוחדים
                  </h3>
                  <p className="text-sm text-gray-600">
                    זיהוי אוטומטי והעלאת עדיפות ללקוחות VIP
                  </p>
                </div>
                  ...
                  <>
                        ...
                        <Select
                          ...
                          onChange={(e) =>
                            setConfig({
                              ...
                              vipHandling: {
                                ...config.vipHandling,
                                vipIdentificationMethod: e.target.value as any,
                              },
                            })
                          }
                          options={[
                        ...
                        <Select
                          ...
                          onChange={(e) =>
                            setConfig({
                              ...
                              vipHandling: {
                                ...config.vipHandling,
                                vipPriority: e.target.value as any,
                              },
                            })
                          }
                          options={PRIORITY_LEVELS.filter(
                            (p) => p.value === 'urgent' || p.value === 'high'
                          )}
                        />
                      </div>
                    </div>

                    {config.vipHandling.vipIdentificationMethod ===
                      'crm_field' && (
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                          שם שדה VIP ב-CRM
                    ...
                    {config.vipHandling.vipIdentificationMethod ===
                      ...
                      <div>
                        ...
                        <Input
                          value={
                            config.vipHandling.vipDomains?.join(', ') || ''
                          }
                          onChange={(e) =>
                            setConfig({
                              ...config,
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setConfig({
                              ...
                              vipHandling: {
                                ...config.vipHandling,
                                autoPriorityBoost: e.target.checked,
                              },
                            })
                          }
                          className="rounded border-gray-300"
                        ...
                        <Select
                          ...
                          onChange={(e) =>
                            setConfig({
                              ...
                              vipHandling: {
                                ...config.vipHandling,
                                vipNotificationMethod: e.target.value as any,
                              },
                            })
                          }
                          options={[
                            ...
                            {
                              value: 'dedicated_queue',
                              label: 'תור ייעודי VIP',
                            },
                            {
                              value: 'auto_assign_senior',
                              label: 'הקצאה אוטומטית לסניור',
                            },
                          ]}
                        />
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-red-700">
                            לקוח VIP עם סנטימנט שלילי = סיכון מוניטין גבוה. וודא
                            שיש תהליך להעלאה מיידית למנהל account או סניור.
                          </p>
                        </div>
                      </div>
                    </div>
