...
export const AILeadQualifierSpec: React.FC = () => {
  ...
  const [config, setConfig] = useState<AILeadQualifierRequirements>({
    ...
    conversationFlow: {
      ...
      greetingMessage:
        'שלום! אשמח לעזור לכם למצוא את הפתרון המתאים. נשאל כמה שאלות קצרות.',
  ...
  const [activeTab, setActiveTab] = useState<
    'basic' | 'bant' | 'conversation' | 'scoring' | 'followup' | 'performance'
  >('basic');
  ...
  useEffect(() => {
    ...
    const existing = aiAgentServices.find(
      (a: AIAgentServiceEntry) => a.serviceId === 'ai-lead-qualifier'
    );
  ...
  const handleFieldChange = useCallback(
    <T extends keyof AILeadQualifierRequirements>(
      field: T,
  ...
  const removeBantQuestion = (
    ...
    setConfig((prevConfig) => {
      const updatedQuestions = prevConfig.bantCriteria[
        category
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                AI Lead Qualifier - Service #22 - BANT Methodology & Predictive
                Scoring
              </p>
            </div>
            <Button
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-700">
                        BANT = Budget (תקציב), Authority (סמכות), Need (צורך),
                        Timeline (לוח זמנים). מסגרת מוכחת לסינון לידים שמגדילה
                        conversion rates ב-30% ומפחיתה CAC ב-25%.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="mb-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Button
                        onClick={() => addBantQuestion('budget')}
                        size="sm"
                        variant="outline"
                      >
                      ...
                      {config.bantCriteria.budget.questions.map((q, idx) => (
                        <div key={idx} className="flex gap-2">
                          <Input
                            value={q}
                            onChange={(e) =>
                              updateBantQuestion('budget', idx, e.target.value)
                            }
                            placeholder="שאלה..."
                          />
                          <button
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="mb-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Button
                        onClick={() => addBantQuestion('authority')}
                        size="sm"
                        variant="outline"
                      >
                        <Plus className="w-4 h-4 ml-1" />
                      ...
                      {config.bantCriteria.need.questions.map((q, idx) => (
                        <div key={idx} className="flex gap-2">
                          <Input
                            value={q}
                            onChange={(e) =>
                              updateBantQuestion('need', idx, e.target.value)
                            }
                            placeholder="שאלה..."
                          />
                          <button
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="mb-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Button
                        onClick={() => addBantQuestion('timeline')}
                        size="sm"
                        variant="outline"
                      >
                        <Plus className="w-4 h-4 ml-1" />
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleFieldChange('conversationFlow', {
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onChange={(e) =>
                        handleFieldChange('conversationFlow', {
                          ...config.conversationFlow,
                          conversationType: e.target.value as any,
                        })
                      }
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-700">
                        שיחה שיחתית (Conversational) נותנת חוויה טבעית יותר אבל
                        קשה יותר לשלוט. שיחה מובנית (Structured) נותנת נתונים
                        עקביים יותר ונוח יותר לניתוח.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleFieldChange('leadScoring', {
                          ...config.leadScoring,
                          qualifiedThreshold: parseInt(e.target.value),
                        })
                      }
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      מתחת לסף = unqualified
                    </p>
                  </div>
                    ...
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) =>
                          handleFieldChange('leadScoring', {
                            ...config.leadScoring,
                            usePredictiveAnalytics: e.target.checked,
                          })
                        }
                        className="rounded border-gray-300"
                      />
                      ...
                      <input
                        ...
                        checked={
                          config.leadScoring.additionalFactors
                            ?.websiteBehavior || false
                        }
                        onChange={(e) =>
                          handleNestedFieldChange(
                            'leadScoring',
                            'additionalFactors.websiteBehavior',
                            e.target.checked
                          )
                        }
                        className="rounded border-gray-300"
                    ...
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) =>
                          handleNestedFieldChange(
                            'leadScoring',
                            'additionalFactors.emailEngagement',
                            e.target.checked
                          )
                        }
                        className="rounded border-gray-300"
                      />
                      <span className="text-sm text-gray-700">
                        מעורבות באימיילים (Email Engagement)
                      </span>
                    </label>
                    ...
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) =>
                          handleNestedFieldChange(
                            'leadScoring',
                            'additionalFactors.contentDownloads',
                            e.target.checked
                          )
                        }
                        className="rounded border-gray-300"
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-700">
                        ניקוד לידים עם AI מזהה 40% יותר הזדמנויות מוסמכות ומגדיל
                        conversion rates ב-30%. זמן סינון: 2 שעות → 2 דקות (98%
                        חיסכון בזמן).
                      </p>
                    </div>
                  </div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleFieldChange('followUp', {
                          ...config.followUp,
                          autoThankYouEmail: e.target.checked,
                        })
                      }
                      className="rounded border-gray-300"
                    />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleFieldChange('followUp', {
                        ...config.followUp,
                        qualifiedEmailTemplate: e.target.value,
                      })
                    }
                    rows={4}
                    className="w-full rounded-md border border-gray-300 p-2"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleFieldChange('followUp', {
                        ...config.followUp,
                        unqualifiedEmailTemplate: e.target.value,
                      })
                    }
                    rows={4}
                    className="w-full rounded-md border border-gray-300 p-2"
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-700">
                        ...
                        לידים מוסמכים - הזמנה לפגישה. לידים לא מוסמכים - הצעת
                        תוכן חינוכי או nurturing.
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleFieldChange('performance', {
                          ...config.performance,
                          dailyLeadVolume: parseInt(e.target.value),
                        })
                      }
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleFieldChange('performance', {
                          ...config.performance,
                          qualificationRateTarget: parseInt(e.target.value),
                        })
                      }
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      כמה % מהלידים יהיו מוסמכים
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleFieldChange('performance', {
                          ...config.performance,
                          completionRateTarget: parseInt(e.target.value),
                        })
                      }
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      כמה % מהלידים ישלימו את השאלון
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    {config.channels.map((ch, idx) => (
                      <label key={idx} className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-sm text-gray-700">
                          {CHANNELS.find((c) => c.value === ch.channel)
                            ?.label || ch.channel}
                        </span>
                      </label>
                    ))}
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-gray-900">
                        {config.performance.dailyLeadVolume}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-700">
                        לידים מוסמכים צפויים (יומי):
                      </span>
                      <span className="font-bold text-green-600">
                        {Math.round(
                          (config.performance.dailyLeadVolume *
                            config.performance.qualificationRateTarget) /
                            100
                        )}
                      </span>
                    </div>
