      ...
      <Card title="שירות #26: AI - זרימות עבודה מורכבות">
        <div className="space-y-4">
          ...
          <div>
            ...
            <input type="text" value={config.workflowName} onChange={(e) => handleFieldChange('workflowName', e.target.value)}
          ...
          <div className="space-y-3">
            <label className="flex items-center">
              <input type="checkbox" checked={config.monitoringEnabled}
                onChange={(e) => handleFieldChange('monitoringEnabled', e.target.checked)} className="mr-2" />
