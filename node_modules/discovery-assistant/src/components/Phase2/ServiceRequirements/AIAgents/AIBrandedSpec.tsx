...
export function AIBrandedSpec() {
  ...
  const [config, setConfig] = useState<AIBrandedRequirements>({
    ...
    conversationFlow: {
      greeting:
        'שלום! אני העוזר הוירטואלי של {companyName}. איך אוכל לעזור לך היום?',
      fallback:
        'מצטער, לא הבנתי לגמרי. האם תוכל לנסח אחרת או לשאול על נושאים ספציפיים כמו השירותים שלנו או פרטי התקשרות?',
  ...
  const handleFieldChange = useCallback(
    (field: keyof AIBrandedRequirements, value: any) => {
      setConfig((prev) => {
  ...
  return (
    <div className="space-y-6" dir="rtl">
      ...
      <Card
        title="סוכן AI ממותג"
        subtitle="יצירת סוכן AI המותאם למותג ולקול של החברה שלכם"
      >
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFieldChange('branding.companyName', e.target.value)
                  }
                  className="w-full p-2 border rounded-lg"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFieldChange('branding.logoUrl', e.target.value)
                  }
                  className="w-full p-2 border rounded-lg"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFieldChange('branding.primaryColor', e.target.value)
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFieldChange('branding.secondaryColor', e.target.value)
                  }
                  className="w-full p-2 border rounded-lg h-10"
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleFieldChange(
                      'capabilities.conversationStyle',
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    handleFieldChange(
                      'capabilities.formalLanguage',
                      e.target.checked
                    )
                  }
                />
                <label htmlFor="formalLanguage" className="text-sm">
                  שפה פורמלית
                </label>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleFieldChange(
                      'knowledgeBase.companyInfo.history',
                      e.target.value
                    )
                  }
                  rows={3}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleFieldChange(
                      'knowledgeBase.companyInfo.values',
                      e.target.value
                    )
                  }
                  rows={3}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleFieldChange(
                      'knowledgeBase.companyInfo.uniqueSellingPoints',
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium mb-2">
                  מילות מפתח להעברה לאדם
                </label>
                <textarea
                  value={config.conversationFlow.transferTriggers.join('\n')}
                  onChange={(e) =>
                    handleFieldChange(
                      'conversationFlow.transferTriggers',
                      e.target.value.split('\n').filter((s) => s.trim())
                    )
                  }
                  rows={2}
