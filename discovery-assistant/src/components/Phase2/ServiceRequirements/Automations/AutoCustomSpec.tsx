        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                handleFieldChange('customDescription', e.target.value)
              }
              rows={4}
              className="w-full px-3 py-2 border border-gray-300 rounded-md"
              placeholder="תאר את האוטומציה המבוקשת בפירוט..."
            />
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  handleFieldChange('complexity', e.target.value as any)
                }
                className="w-full px-3 py-2 border border-gray-300 rounded-md"
              >
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 border border-gray-300 rounded-md"
              placeholder="אבטחה, ביצועים, אינטגרציות..."
            />
          </div>
