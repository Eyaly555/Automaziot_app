...
export function AIFullIntegrationSpec() {
  ...
  useEffect(() => {
    ...
    const existing = aiAgentServices.find(
      (a: AIAgentServiceEntry) => a.serviceId === 'ai-full-integration'
    );
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                handleFieldChange('orchestration', e.target.value)
              }
          ...
          <div className="space-y-3">
            <label className="flex items-center">
              <input
                ...
                onChange={(e) =>
                  handleFieldChange('continuousLearning', e.target.checked)
                }
                className="mr-2"
              />
