...
export function AIComplexWorkflowSpec() {
  ...
  useEffect(() => {
    ...
    const existing = aiAgentServices.find(
      (a: AIAgentServiceEntry) => a.serviceId === 'ai-complex-workflow'
    );
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleFieldChange('workflowName', e.target.value)
              }
              className="w-full px-3 py-2 border border-gray-300 rounded-md"
              placeholder="תהליך עסקי מורכב"
            />
          </div>
          ...
          <div className="space-y-3">
            <label className="flex items-center">
              <input
                ...
                onChange={(e) =>
                  handleFieldChange('monitoringEnabled', e.target.checked)
                }
                className="mr-2"
              />
