...
export function AIFormAssistantSpec() {
  ...
  const { saveData, isSaving, saveError } = useAutoSave({
    moduleId: 'ai-form-assistant',
    immediateFields: ['aiModel', 'formTypes', 'assistanceLevel', 'helpContent'], // Critical configuration fields
    debounceMs: 1000,
    onError: (error) => {
      console.error('Auto-save error in AIFormAssistantSpec:', error);
    }
  });
