...
export const ReportingModule: React.FC = () => {
  ...
  const [criticalAlerts, setCriticalAlerts] = useState<string[]>(
    moduleData.criticalAlerts || []
  );

  // 5.2 Scheduled Reports
  const [reports, setReports] = useState<Report[]>(
    moduleData.scheduledReports || []
  );
  ...
  const [dashboardExists, setDashboardExists] = useState(
    moduleData.dashboards?.exists || false
  );
  const [realTimeDashboard, setRealTimeDashboard] = useState(
    moduleData.dashboards?.realTime || false
  );
  const [anomalyDetection, setAnomalyDetection] = useState(
    moduleData.dashboards?.anomalyDetection || ''
  );
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    התראות קריטיות ועדכונים מיידיים
                  </p>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <Input
                      ...
                      onChange={(v) =>
                        setNewAlert({ ...newAlert, recipients: v })
                      }
                    ...
                    <div className="flex gap-2">
                      <Select
                        ...
                        onChange={(v) =>
                          setNewAlert({ ...newAlert, frequency: v })
                        }
                        options={[
                        ...
                        dir="rtl"
                      />
                      <Button onClick={handleAddAlert} variant="primary">
                    ...
                    {Array.isArray(reports) &&
                      reports.map((report, index) => (
                        ...
                        >
                          ...
                          <span className="text-sm text-gray-600">
                            תדירות: {report.frequency}
                          </span>
                          <span className="text-sm text-gray-600">
                            זמן הכנה: {report.timeToCreate} דק'
                          </span>
                          <span className="text-sm text-gray-600">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div className="flex gap-2">
                      <Input
                        ...
                        onChange={(v) =>
                          setNewReport({ ...newReport, distribution: v })
                        }
                        placeholder="רשימת תפוצה (מופרדים בפסיק)"
                        className="flex-1"
                        dir="rtl"
                      />
                      <Button onClick={handleAddReport} variant="primary">
                        <Plus className="w-5 h-5" />
                      </Button>
                    </div>
                  </div>
                ...
                {calculateReportingLoad() > 40 && (
                  <div className="p-4 bg-orange-50 rounded-lg">
                    <p className="text-orange-800 font-medium">
                      ⚠️ עומס דוחות גבוה: {Math.round(calculateReportingLoad())}{' '}
                      שעות/חודש
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                      ...
                      <div className="flex gap-2">
                        <Select
                          ...
                          dir="rtl"
                        />
                        <Button onClick={handleAddKpi} variant="primary">
                          <Plus className="w-5 h-5" />
                        </Button>
                      </div>
                    </div>
