      ...
      datasets: [
        {
          ...
          pointRadius: (context: any) => {
            ...
            return scenarios.conservative && Math.abs(month - scenarios.conservative.paybackPeriod) < 0.5
              ? 6
              : 0;
          },
        ...
        },
        {
          ...
          pointRadius: (context: any) => {
            const month = context.dataIndex + 1;
            return scenarios.realistic && Math.abs(month - scenarios.realistic.paybackPeriod) < 0.5 ? 6 : 0;
          },
        ...
        },
        {
          ...
          pointRadius: (context: any) => {
            const month = context.dataIndex + 1;
            return scenarios.optimistic && Math.abs(month - scenarios.optimistic.paybackPeriod) < 0.5 ? 6 : 0;
          },
    ...
    return (
      <Card variant="glass">
        <div className="text-center py-12 text-gray-500">
          ...
          <p className="text-sm mt-2">השלם את חישובי ה-ROI כדי לראות את הוויזואליזציות</p>
        </div>
      </Card>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card title="פירוט עלויות" subtitle="התפלגות עלויות ההשקעה" variant="glass">
          <div className="h-80">
            <Doughnut data={generateCostBreakdownData()} options={costBreakdownOptions} />
          </div>
        </Card>
        ...
        <Card title="השוואת ROI" subtitle="החזר השקעה באחוזים" variant="glass">
          <div className="h-80">
            <Bar data={generateROIComparisonData()} options={roiComparisonOptions} />
          </div>
        </Card>
      </div>

      {/* Scenario Comparison Table */}
      <Card title="טבלת השוואה מפורטת" subtitle="השוואה מלאה בין שלושת התרחישים" variant="glass">
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b-2 border-gray-200">
                <th className="text-right py-3 px-4 font-semibold text-gray-700">מדד</th>
            ...
            <tbody className="divide-y divide-gray-200">
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="py-3 px-4 font-medium text-gray-700">חיסכון חודשי</td>
              ...
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="py-3 px-4 font-medium text-gray-700">עלות הטמעה</td>
                <td className="text-center py-3 px-4 text-red-700">
              ...
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="py-3 px-4 font-medium text-gray-700">עלויות חודשיות שוטפות</td>
                <td className="text-center py-3 px-4 text-red-700">
              ...
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="py-3 px-4 font-medium text-gray-700">תקופת החזר (חודשים)</td>
              ...
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="py-3 px-4 font-medium text-gray-700">ROI לאחר 12 חודשים</td>
                <td className="text-center py-3 px-4 text-red-700 font-semibold">
              ...
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="py-3 px-4 font-medium text-gray-700">ROI לאחר 24 חודשים</td>
                <td className="text-center py-3 px-4 text-red-700 font-semibold">
              ...
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="py-3 px-4 font-medium text-gray-700">ROI לאחר 36 חודשים</td>
                <td className="text-center py-3 px-4 text-red-700 font-semibold">
              ...
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="py-3 px-4 font-medium text-gray-700">לאחר 12 חודשים</td>
              ...
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="py-3 px-4 font-medium text-gray-700">לאחר 24 חודשים</td>
                <td className="text-center py-3 px-4 text-red-700 font-bold">
              ...
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="py-3 px-4 font-medium text-gray-700">לאחר 36 חודשים</td>
                <td className="text-center py-3 px-4 text-red-700 font-bold">
